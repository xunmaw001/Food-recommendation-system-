...
<view class="list-box4"
    ...
    <block v-for="(product,index) in meishiList" :key="index">
        <view v-if="index%6==0" @tap="onDetailTap('meishi',product.id)" class="list-item"
            ...
            <image
                    ...
                    mode="aspectFill" :src="baseUrl+product.meishiPhoto">
            </image>
        ...
        <view v-if="index%6==1" @tap="onDetailTap('meishi',product.id)"
        ...
        <view v-if="index%6==2" @tap="onDetailTap('meishi',product.id)"
        ...
        <view v-if="index%6==3" @tap="onDetailTap('meishi',product.id)" class="list-item"
        ...
        <view v-if="index%6==4" @tap="onDetailTap('meishi',product.id)"
        ...
        <view v-if="index%6==5" @tap="onDetailTap('meishi',product.id)"
...
<view class="list-box4"
      :style='{"padding":"24rpx","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'
      style="display:flex;flex-wrap:wrap;box-sizing: border-box;align-content: flex-start;">
    <block v-for="(product,index) in shangjiaList" :key="index">
        <view v-if="index%6==0" @tap="onDetailTap('shangjia',product.id)" class="list-item"
              :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 0 20rpx 0","borderColor":"red","backgroundColor":"rgba(0, 206, 209, 0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
            <image
                    :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 0 8rpx 0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(255,0,0,0)","borderRadius":"200rpx 200rpx 20rpx 200rpx","borderWidth":"6rpx","width":"100%","borderStyle":"solid","height":"200rpx"}'
                    mode="aspectFill" :src="baseUrl+product.shangjiaPhoto">
            </image>
            <view class="list-item-body" style="display: flex;flex-wrap: wrap;">
                <view
                        :style='{"padding":"0 24rpx","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(163, 169, 228, 0)","color":"#333","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"36rpx","fontSize":"28rpx","borderStyle":"solid"}'
                        class="title hide1">{{product.shangjiaName}}
                </view>
            </view>
        </view>
        <view v-if="index%6==1" @tap="onDetailTap('shangjia',product.id)"
              :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 2% 20rpx 0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","borderRadius":"0","borderWidth":"0","width":"48%","borderStyle":"solid","height":"auto"}'>
            <image
                    :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(255,0,0,0)","borderRadius":"20rpx 100rpx 100rpx 100rpx","borderWidth":"10rpx","width":"100%","borderStyle":"solid","height":"200rpx"}'
                    mode="aspectFill" :src="baseUrl+product.shangjiaPhoto">
        ...
        <view v-if="index%6==2" @tap="onDetailTap('shangjia',product.id)"
              :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 0 20rpx 2%","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","borderRadius":"0","borderWidth":"0","width":"48%","borderStyle":"solid","height":"auto"}'>
            <image
                    :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(255,0,0,0)","borderRadius":"100rpx 20rpx 100rpx 100rpx","borderWidth":"10rpx","width":"100%","borderStyle":"solid","height":"200rpx"}'
                    mode="aspectFill" :src="baseUrl+product.shangjiaPhoto">
        ...
        <view v-if="index%6==3" @tap="onDetailTap('shangjia',product.id)" class="list-item"
              :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 0 20rpx 0","borderColor":"var(--publicSubColor)","backgroundColor":"var(--publicSubColor)","borderRadius":"0 0 30rpx 30rpx","borderWidth":"6rpx","width":"100%","borderStyle":"solid","height":"auto"}'>
            <image
                    :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"200rpx"}'
                    mode="aspectFill" :src="baseUrl+product.shangjiaPhoto">
        ...
        <view v-if="index%6==4" @tap="onDetailTap('shangjia',product.id)"
              :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 2% 0 0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","borderRadius":"0","borderWidth":"0","width":"48%","borderStyle":"solid","height":"auto"}'>
            <image
                    :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(255,0,0,0)","borderRadius":"100rpx 100rpx 100rpx 20rpx","borderWidth":"10rpx","width":"100%","borderStyle":"solid","height":"200rpx"}'
                    mode="aspectFill" :src="baseUrl+product.shangjiaPhoto">
        ...
        <view v-if="index%6==5" @tap="onDetailTap('shangjia',product.id)"
              :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 0 0 2%","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","borderRadius":"0","borderWidth":"0","width":"48%","borderStyle":"solid","height":"auto"}'>
            <image
                    :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(255,0,0,0)","borderRadius":"100rpx 100rpx 20rpx 100rpx","borderWidth":"10rpx","width":"100%","borderStyle":"solid","height":"200rpx"}'
                    mode="aspectFill" :src="baseUrl+product.shangjiaPhoto">
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let meishi = await this.$api.requestCondition('meishi','gexingtuijian',meishiVal);
            ...
            // let shangjia = await this.$api.requestCondition('shangjia','gexingtuijian',shangjiaVal);
