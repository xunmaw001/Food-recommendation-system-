<template>
	<view class="content">
        <view class="box"
		 ...
		 <view v-if="tableName=='yonghu'" class="cu-form-group">
			 <view class="title"
				   :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'>昵称
			 </view>
			 <input
					:style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
					v-model="ruleForm.yonghuName" placeholder="昵称"></input>
		 </view>
		 <view v-if="tableName=='yonghu'" class="cu-form-group">
			 <view class="title"
		 ...
		 <view v-if="tableName=='yonghu'" class="cu-form-group">
			...
			<view
				...
				<view class="title"
					  :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'>生日
				</view>
				<input @tap="toggleTab('yonghuTime')"
					   :style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
					   v-model="ruleForm.yonghuTime" placeholder="生日"></input>
			</view>
		...
		<view class="btn" style="margin-top:40rpx">
			...
			<w-picker mode="date" step="1" :current="false" :hasSecond="false" @confirm="yonghuTimeConfirm"
					  ref="yonghuTime" themeColor="#333333"></w-picker>
...
<script>
	export default {
		...
		methods: {
			...
			// 日期控件
			yonghuTimeConfirm(val) {
				this.ruleForm.yonghuTime = val.result;
				this.$forceUpdate();
			},
			// 日期控件
			...
			async update() {
					...
					if ((!this.ruleForm.yonghuTime) && `yonghu` == this.tableName) {
						this.$utils.msg(`生日不能为空`);
						return
					}
