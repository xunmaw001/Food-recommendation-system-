	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        <view class="search-form round">
				<input :style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
						v-model="searchForm.shangjiaName" type="text" placeholder="餐厅名称"></input>
		</view>
        ...
        <view class="action">
            ...
            <view v-if="isAuth('shangjia','报表')" @tap="openChartDialog" :style="{padding:'0 10rpx',lineHeight:'80rpx',width:'auto',height:'80rpx',fontSize:'28rpx',color:'rgba(239, 239, 239, 1)',backgroundColor:btnColor[0],borderColor:btnColor[0]}">
                报表
            </view>
                ...
                <scroll-view scroll-y="true" class="tabView" :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"10rpx 0 0 ","borderColor":"rgba(0,0,0,1)","borderRadius":"0","borderWidth":"0","borderStyle":"solid","height":"auto"}'>
                    <view style="display: flex;">
                        <view style="display: flex;flex-direction: column;width: 100%;">
                            <view :style='shangjiaTypes===item.codeIndex?sactiveItem:sitem' class="tab"
                                  v-for="(item,index) in shangjiaTypesList" :key="index" :class="shangjiaTypes===item.codeIndex?'tabActive':''"
                                  @tap="shangjiaTypesCategoryClick(item.codeIndex)">
                                {{item.indexName}}
                            </view>
                        </view>
                    </view>
    ...
    <block v-for="(product,index) in list" :key="index">
        <view @tap="onDetailTap(product)" v-if="index%6==0" class="list-item"
            ...
            <image
                    ...
                    mode="aspectFill" :src="product.shangjiaPhoto?baseUrl+product.shangjiaPhoto.split(',')[0]:''">
            </image>
            <view class="list-item-body" style="flex: 1;">
                ...
                <view v-if="product.shangjiaNewMoney"
                      ...
                      class="title hide1">￥{{product.shangjiaNewMoney}}
                </view>
                <view v-else-if="product.shangjiaValue"
                      :style='{"padding":"10rpx","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"rgba(0, 0, 0, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"40rpx","fontSize":"28rpx","borderStyle":"solid"}'
                      class="title hide1">{{product.shangjiaValue}}
                </view>
...
<script>
	export default {
		...
		methods: {
            ...
            //当前表的 餐厅类型字段类别搜索
			shangjiaTypesCategoryClick(categoryName) {
			...
			async upCallback(mescroll) {
                ...
                if (this.shangjiaTypes != 0) {
                    params.shangjiaTypes = this.shangjiaTypes
                }
                let _this = this
