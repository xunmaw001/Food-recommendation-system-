    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">美食推荐系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="餐厅名称" class="input" v-if="tableName=='shangjia'">
                            <el-input v-model="ruleForm.shangjiaName" autocomplete="off" placeholder="餐厅名称"  />
                        </el-form-item>
                        ...
                        -->
                        <!--
                            <el-form-item label="餐厅地址" class="input" v-if="tableName=='shangjia'">
                                <el-input v-model="ruleForm.shangjiaAddress" autocomplete="off" placeholder="餐厅地址"  />
                           </el-form-item>
                        -->
                       <!--<el-form-item class="input" label="餐厅类型">
                            <el-select style="width: 399px;height: 40px;" v-model="ruleForm.shangjiaTypes" placeholder="请选择餐厅类型">
                                <el-option
                        ...
                        -->
                        <!--
                            <el-form-item label="餐厅介绍" class="input" v-if="tableName=='shangjia'">
                                <el-input type="textarea" v-model="ruleForm.shangjiaContent" placeholder="餐厅介绍"></el-input>
                           </el-form-item>
                        -->
                        <!--
                        ...
                        <el-form-item label="昵称" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuName" autocomplete="off" placeholder="昵称"  />
                        </el-form-item>
                        ...
                        <!--
                            <el-form-item label="生日" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.yonghuTime" autocomplete="off" placeholder="生日"  />
                           </el-form-item>
                        -->
                        <!--
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/meishituijianxitong/img/back-img-bg.jpg);
