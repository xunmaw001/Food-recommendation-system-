<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='shangjia'"  label='餐厅名称' prop="shangjiaName">
               <el-input v-model="ruleForm.shangjiaName"  placeholder='餐厅名称' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='shangjia'"  label='餐厅地址' prop="shangjiaAddress">
               <el-input v-model="ruleForm.shangjiaAddress"  placeholder='餐厅地址' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
             <el-form-item v-if="flag=='shangjia'"  label='餐厅类型' prop="shangjiaTypes">
                 <el-select v-model="ruleForm.shangjiaTypes"  placeholder='请选择餐厅类型'>
                     <el-option
         ...
         <el-col :span="24">
             <el-form-item v-if="flag=='shangjia'"  label="餐厅介绍" prop="shangjiaContent">
                 <editor
