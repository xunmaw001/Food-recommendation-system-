<template>
    <div class="main-content">
        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/meishituijianxitong/upload/meishiCommentbackMuBan.xls"
                        >批量导入商品评价数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('meishiCommentback','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="meishiCommentbackPingfenNumber"
                                      header-align="center"
                                      label="评分">
                        <template slot-scope="scope">
                            {{scope.row.meishiCommentbackPingfenNumber}}
                        </template>
                    </el-table-column>
		...
		<el-dialog
                ...
                width="30%">
            <span>评分</span>
			<el-rate v-model="meishiCommentbackPingfenNumber" show-score text-color="#ff9900"
...
<script>
    ...
    //当前表下拉框搜索条件
            form:{
                ...
                meishiCommentbackPingfenNumber : null,
                insertTime : null,
                replyText : null,
                updateTime : null,
                createTime : null,
            ...
            json_fields: {
                ...
                //本表字段
                     ...
                     '评分': "meishiCommentbackPingfenNumber",
                     '评价时间': "insertTime",
                     '回复内容': "replyText",
                     '回复时间': "updateTime",
            },
        ...
        //评价
			...
			//评分
		    meishiCommentbackCommentbackPingfenNumber:0,
            };
        },
        created() {
