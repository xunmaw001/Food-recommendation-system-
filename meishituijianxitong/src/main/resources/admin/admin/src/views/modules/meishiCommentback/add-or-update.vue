    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="评分" prop="meishiCommentbackPingfenNumber">
                       <el-input v-model="ruleForm.meishiCommentbackPingfenNumber"
                                 placeholder="评分" clearable  :readonly="ro.meishiCommentbackPingfenNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="评分" prop="meishiCommentbackPingfenNumber">
                           <el-input v-model="ruleForm.meishiCommentbackPingfenNumber"
