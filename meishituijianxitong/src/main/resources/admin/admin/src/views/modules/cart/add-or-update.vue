    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='meishi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品热度" prop="meishiClicknum">
                        <el-input v-model="meishiForm.meishiClicknum"
                                  placeholder="商品热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="商品热度" prop="meishiClicknum">
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="生日" prop="yonghuTime">
                        <el-input v-model="yonghuForm.yonghuTime"
                                  placeholder="生日" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="生日" prop="yonghuTime">
