                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            MeishiEntity meishiEntity = new MeishiEntity();
//                            meishiEntity.setShangjiaId(Integer.valueOf(data.get(0)));   //餐厅 要改的
//                            meishiEntity.setMeishiName(data.get(0));                    //商品名称 要改的
//                            meishiEntity.setMeishiUuidNumber(data.get(0));                    //商品编号 要改的
...
//                            meishiEntity.setMeishiClicknum(Integer.valueOf(data.get(0)));   //商品热度 要改的
