...
//                            shangjiaEntity.setShangjiaName(data.get(0));                    //餐厅名称 要改的
...
//                            shangjiaEntity.setShangjiaAddress(data.get(0));                    //餐厅地址 要改的
//                            shangjiaEntity.setShangjiaTypes(Integer.valueOf(data.get(0)));   //餐厅类型 要改的
...
//                            shangjiaEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(shangjia.getId(),username, "shangjia", "餐厅");
        R r = R.ok();
        r.put("token", token);
        r.put("role","餐厅");
